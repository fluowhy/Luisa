...
class LuisaDataset(object):
    def __init__(self, bs):
        ...
        self.x_train = np.load("../data/processed/x_train_ctc.npy")
        self.x_val = np.load("../data/processed/x_val_ctc.npy")

        self.y_train = np.load("../data/processed/y_train_ctc.npy")
        self.y_val = np.load("../data/processed/y_val_ctc.npy")

        self.seq_len_train = np.load("../data/processed/seq_len_train_ctc.npy")
        self.seq_len_val = np.load("../data/processed/seq_len_val_ctc.npy")
